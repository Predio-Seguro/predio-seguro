...
const RegisterPage = () => {
  return (
    <div className="flex h-screen items-center justify-between max-2xl:justify-center">
        ...
        <div className="w-[60%] max-2xl:bg-[url('/logo-background.png')] bg-contain bg-no-repeat bg-center flex flex-col items-center justify-center gap-14 max-2xl:gap-4">
